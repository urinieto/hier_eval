...
\Cref{fig:hier-flatlarger} illustrates an example of a pure under-segmentation.  Again, small values of $w$
...
\Cref{fig:SALAMI-SALAMI} illustrates two hierarchical annotations from two human annotators on one track in
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{figs/exploring_w_Tf.pdf}
...
the harmonic mean of $\shag_u$ and $\shag_o$.  \Cref{fig:salami-agree} illustrates the distribution of
