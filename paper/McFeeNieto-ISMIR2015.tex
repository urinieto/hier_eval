...
specialize to handle flat (single-layer) annotations, and require no explicit correspondence between the
...
Moreover, the calculation of the $T$-measures as defined in \Cref{shagunder} can be expensive, taking
