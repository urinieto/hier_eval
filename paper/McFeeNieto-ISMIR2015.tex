...
\Cref{fig:salami-olda-stats} displays the $\shag_F$ score distribution for OLDA, measured against annotator $1$.
These results illustrate a significant gap between inter-annotator agreement
(\Cref{fig:salami-agree}) and the performance of OLDA.  This suggests that there is substantial room for
...
%      $w$       & $\shag_R$    & $\shag_P$  & $\shag_R$ & $\shag_P$    \\
%      \hline
%      0.5       & 0.28 & 0.55   & 0.14       & 1.00  \\
%      3         & 0.34 & 0.72   & 0.20       & 1.00     \\
%      15        & 0.66 & 0.70   & 0.62       & 0.56  \\
%      30        & 0.80 & 0.58   & 0.76       & 0.53   \\
%      $\infty$  & 0.93 & 0.42   & 0.90       & 0.16  
%  \end{tabular}
%  \end{minipage}
  \caption{Hierarchical reference annotation vs.\ OLDA on SALAMI track \#636.}
  %(top) and $T$-measures scores (bottom).}
