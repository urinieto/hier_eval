...
\caption{An example of two distinct hierarchical annotation structures which share identical sets of boundaries at each level
independently, but whose overall structure interpretations are quite different.\label{trees}}
\end{figure}
