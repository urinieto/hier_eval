...
\begin{figure}
  ...
  \begin{minipage}{0.5\textwidth}
    ...
    \end{tabular}
  \end{minipage}
  \caption{Hierarchical vs. flat, large-scale boundaries (top) and scores (bottom).  Color corresponds to depth of the least common ancestor of the row- and column-frames 
