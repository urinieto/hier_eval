...
detail, which in this case, is 15s.  This can be easily observed in the $\shag_u$ scores in \Cref{fig:hier-flatsmall}, which drop rapidly when the window size exceeds 15.
