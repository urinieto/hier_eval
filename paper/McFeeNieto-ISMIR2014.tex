...
Its goal is to identify and categorize the form of musical pieces by investigating the organization of their phrases, melodies, recurring motives, etc.
These traditional analyses usually result into multiple layers of annotations, which reinforce the general assumption that music is structured hierarchically \cite{TODO}.
Moreover, tree-like structures are the most long-established method used to model the form of music \cite{TODO:GTTM}.

In the music information retrieval literature, a task that aims to automatically identify the structure of music has been widely discussed under the name of music segmentation \cite{TODO:Paulus}. 
This automatic task could facilitate, e.g., the intra-piece navigation, generation of music summaries, or segment-based recommendation systems.
However, the vast majority of music segmentation algorithms only output flat annotations as opposed to hierarchical ones.


is a classic task widely discussed in the music information retrieval literature.
The goal is to 
