...
Moreover, tree-like structures are the most used long-established representations to model the form of music \cite{Lerdahl1983}.
...
Nevertheless, the vast majority of music segmentation algorithms only operate at a flat level instead of following the hierarchical approach that most musicologist follow.
Various publications encouraging researchers to focus on hierarchical structures instead of flat ones have been made \cite{Peeters2009}, and even a large dataset of hierarchical human annotations has been presented \cite{Smith2011}.
