...
\caption{A toy example of two hierarchical annotation structures with identical boundary sets at each layer --- $(A, B)$ and
$(a,b,c)$ ---  but have distinct structural interpretations.\label{trees}}
\end{figure}
